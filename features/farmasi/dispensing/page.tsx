...
import DispensingNonRacikan from "@/features/farmasi/components/DispensingNonRacikan";
import DispensingRacikan from "@/features/farmasi/components/DispensingRacikan";
    ...
    <div className="bg-white border-b rounded-xl border-slate-200 overflow-hidden">
      <div className="min-h-screen p-4 md:p-6 pb-24 md:pb-28 font-sans text-gray-800">
        ...
        <FooterTombol
          ...
          onKirimDokter={handleKirimDokter} textButton={"Lanjutkan Ke Serah Obat"} textSubButton={""} cetakObat={true}        />
