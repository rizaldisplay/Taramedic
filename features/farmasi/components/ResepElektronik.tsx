        ...
        <div className="p-6 flex flex-col gap-5 max-h-[82vh] overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50/80 p-4 rounded-xl border border-slate-100">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-cyan-100/60 border border-cyan-200 flex items-center justify-center text-cyan-600 shrink-0">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center gap-2">
                  <span className="bg-cyan-50 text-cyan-700 text-xs font-semibold px-2.5 py-0.5 rounded-md border border-cyan-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border border-slate-200/80 rounded-xl p-4 bg-white shadow-xs flex flex-col gap-3">
              <h4 className="text-xs font-bold text-cyan-600 tracking-wider uppercase border-b border-slate-100 pb-2">
                A. Informasi Resep
              </h4>
          ...
          <div className="border border-slate-200/80 rounded-xl p-4 bg-white shadow-xs flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 flex items-center gap-3">
                <div className="p-2 rounded-lg bg-white border border-slate-100 text-cyan-600 shadow-xs">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs font-bold text-slate-800">
                    {data?.aturanPakai || "Sesudah makan"}
                  </span>
                </div>
              </div>
        ...
        <div className="p-6 flex flex-col gap-5 max-h-[82vh] overflow-y-auto">
          ...
          <div className="border border-purple-100/80 rounded-xl p-4 bg-white shadow-xs flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-xs pt-1">
              <div>
                ...
                <span className="font-semibold text-slate-800">
                  {data?.noRacikan || "RAC-20260816-001"}
                </span>
              </div>
              <div>
          ...
          <div className="border border-purple-100/80 rounded-xl p-4 bg-white shadow-xs flex flex-col gap-3">
            ...
            <div className="bg-purple-50/60 border border-purple-100 rounded-lg p-3 flex items-center gap-2.5 text-purple-800 text-xs font-medium">
              ...
              <span>
                Semua bahan telah diverifikasi sesuai resep dokter dan formula
                racikan.
              </span>
            </div>
          </div>
...
export default function ResepElektronikComponent() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full mx-auto font-sans p-4 sm:p-6 bg-slate-50/30 min-h-screen">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-xs flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-start gap-4">
          <div className="bg-cyan-50 p-3 rounded-xl border border-cyan-100 text-cyan-600 shrink-0">
            <FileText className="w-6 h-6" />
          </div>
          <div className="flex flex-col gap-1.5">
            <h2 className="text-xs font-bold text-cyan-600 tracking-wider uppercase">
              Resep Elektronik
            </h2>
        ...
        <div className="flex border border-slate-200 rounded-xl divide-x divide-slate-200 bg-slate-50/50 self-stretch md:self-auto">
          <div className="px-4 py-2.5 flex flex-col items-center justify-center flex-1 md:flex-initial">
            <span className="text-[11px] text-slate-400 mb-0.5">
              Total Resep
            </span>
            <span className="font-bold text-slate-800 text-sm">
              3 <span className="text-xs font-normal text-slate-400">Item</span>
            </span>
          </div>
          <div className="px-4 py-2.5 flex flex-col items-center justify-center flex-1 md:flex-initial">
            <span className="text-[11px] text-slate-400 mb-0.5">
            ...
            <span className="font-bold text-slate-800 text-sm">
              2 <span className="text-xs font-normal text-slate-400">Item</span>
            </span>
          </div>
          <div className="px-4 py-2.5 flex flex-col items-center justify-center flex-1 md:flex-initial">
            <span className="text-[11px] text-slate-400 mb-0.5">Racikan</span>
            <span className="font-bold text-slate-800 text-sm">
              1 <span className="text-xs font-normal text-slate-400">Item</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-2">
        <button className="bg-cyan-600 text-white px-5 py-2 rounded-full text-xs font-semibold shadow-xs">
          Semua (3)
        </button>
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <h3 className="font-bold text-slate-800 text-xs tracking-wider">
            NON-RACIKAN
          </h3>
          <span className="bg-cyan-50 text-cyan-600 px-2.5 py-0.5 rounded-full text-[11px] font-semibold border border-cyan-100">
            2 Item
          </span>
        </div>
        ...
        {sampleMedicines.map((item, index) => (
          <div
            key={item.id}
            className="bg-white border border-slate-200/80 rounded-xl p-5 shadow-xs flex flex-col gap-4 relative"
          >
            <div className="absolute left-5 top-5 font-bold text-xs text-slate-300">
              {index + 1}
            </div>

            <div className="ml-6 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
              <div className="md:col-span-4 flex gap-3">
                <div className="bg-cyan-50 p-2.5 rounded-xl border border-cyan-100 text-cyan-600 shrink-0">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-400 mt-1 flex items-center gap-1.5 flex-wrap">
                    ...
                    <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                    <span className="text-cyan-600 font-medium">Generik</span>
                  </div>
                </div>
              </div>
            ...
            <div className="ml-6 border-t border-slate-100 pt-3 flex justify-between items-center">
              ...
              <button
                ...
                className="text-cyan-600 hover:text-cyan-700 text-xs font-semibold flex items-center gap-1.5 transition-colors cursor-pointer"
              >
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="bg-white border border-slate-200/80 rounded-xl p-5 shadow-xs flex flex-col gap-4">
            ...
            <div className="flex gap-3">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center text-xs text-slate-600 gap-2 flex-wrap">
                  <span>
                    Bentuk: <strong className="text-slate-800">Puyer</strong>
                  </span>
                  <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                  <span>
                    Jumlah:{" "}
                    <strong className="text-slate-800">10 bungkus</strong>
                  </span>
                </div>
                <div className="flex items-center text-xs text-slate-600 gap-2 flex-wrap">
                  <span>
                    Dosis: <strong className="text-slate-800">1 bungkus</strong>
                  </span>
                  <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                  <span>
                    Frekuensi:{" "}
                    <strong className="text-slate-800">3 x sehari</strong>
                  </span>
                  <span className="w-1 h-1 bg-slate-300 rounded-full"></span>
                  <span>
                    Rute: <strong className="text-slate-800">Oral</strong>
                  </span>
                </div>
                <div className="text-xs text-slate-600">
                  Aturan Pakai:{" "}
                  <strong className="text-slate-800">Sesudah makan</strong>
                </div>
              </div>
            </div>
          ...
          >
            <span className="text-xs font-semibold text-slate-700 group-hover:text-purple-700 transition-colors">
              Komposisi (3 bahan)
            </span>
            <div className="flex items-center gap-1.5 text-cyan-600 group-hover:text-purple-700 text-xs font-semibold transition-colors">
              Lihat Komposisi
