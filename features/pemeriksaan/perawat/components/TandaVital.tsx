  ...
  return (
    <div className="w-full max-w-5xl p-6 bg-white rounded-xl border border-gray-200 shadow-sm font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {/* Tekanan Darah */}
        <div className="flex flex-col gap-1.5 p-3 rounded-lg border border-gray-100 bg-gray-50/50 hover:bg-white hover:border-blue-200 transition-all">
          <label className="text-xs font-semibold text-gray-600 flex items-center gap-1.5">
            <Activity className="w-3.5 h-3.5 text-blue-500" />
            Tekanan Darah
          </label>
          <div className="relative flex items-center">
            <div className="flex items-center w-full bg-white border border-gray-300 rounded-md overflow-hidden focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
              <input
                type="text"
                name="systolic"
        ...
        <div className="flex flex-col gap-1.5 p-3 rounded-lg border border-gray-100 bg-gray-50/50 hover:bg-white hover:border-blue-200 transition-all">
          ...
          <div className="relative flex items-center">
            <input
              ...
              onChange={handleChange}
              placeholder="80"
              className="w-full px-3 py-1.5 bg-white border border-gray-300 rounded-md text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            <span className="ml-2 text-xs text-gray-400 font-medium whitespace-nowrap">
              x/menit
            </span>
