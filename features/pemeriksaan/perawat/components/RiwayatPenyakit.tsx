...
export default function RiwayatPenyakit({
  value,
  onChange,
          ...
          {CONSCIOUSNESS_OPTIONS.map((option) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-medium border transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400 ${
                  isSelected
