      ...
      <div className="w-full bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <textarea 
              className="w-full border border-gray-200 rounded-lg p-3 text-[13px] text-gray-800 focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-cyan-500 transition-all min-h-[110px] resize-y"
