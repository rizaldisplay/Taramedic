...
export default function RiwayatPenyakitDahulu() {
    ...
    <div className="w-full rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-lg p-3.5 h-full min-h-[90px] flex flex-wrap gap-2 content-start">
            <span className="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-md shadow-sm">
              Hipertensi
            </span>
            <span className="px-3 py-1.5 text-xs font-medium text-gray-700 bg-white border border-gray-200 rounded-md shadow-sm">
              Diabetes
