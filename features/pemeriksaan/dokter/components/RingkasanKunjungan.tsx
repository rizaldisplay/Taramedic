      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
            ...
            <button className="flex items-center gap-1.5 text-xs text-blue-600 font-medium hover:underline pt-2">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <div className="flex gap-2">
                <button className="px-3 py-1.5 border border-blue-600 text-blue-600 rounded-md text-xs font-medium hover:bg-blue-50">
                  Konfirmasi
                </button>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="relative pl-6 space-y-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
              ...
              {/* Step 2 - In Progress */}
              <div className="relative">
                <div className="absolute -left-[1.65rem] top-0.5 w-4 h-4 rounded-full bg-blue-600 border-2 border-white"></div>
                <div>
                  <p className="text-xs font-bold text-blue-600">Pemeriksaan Dokter</p>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center justify-between p-2 rounded-lg bg-slate-50 border border-slate-100">
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-1.5 py-0.5 bg-blue-100 text-blue-600 rounded text-[10px] font-bold">PDF</span>
                </div>
            ...
            <button className="flex items-center gap-1.5 text-xs text-blue-600 font-medium border border-blue-200 px-3 py-1.5 rounded-lg hover:bg-blue-50">
              <Eye className="w-3.5 h-3.5" />
              Lihat Semua Dokumen
            </button>
          </div>
